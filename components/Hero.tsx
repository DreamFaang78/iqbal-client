        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <motion.div variants={fadeUp} className="flex flex-wrap gap-2">
              {[
                'Zindagi bhar ki dawai nahi',
                'Painful injections nahi',
                'Sirf permanent healing',
              ].map((point) => (
                <span
                  key={point}
            ...
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-3 pt-1">
              ...
              >
                ...
                <span className="relative z-10 tracking-wide">FREE Consultation Book Karein</span>
              </Link>
            ...
            <motion.div variants={fadeUp}>
              ...
              >
                ...
                WhatsApp pe seedha Dr. Iqbal se baat karein →
              </a>
            </motion.div>
