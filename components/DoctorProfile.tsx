...
export default function DoctorProfile() {
  return (
    <section id="doctor" className="py-24 bg-[#0D1F3A] relative overflow-hidden font-sans">
      {/* Decorative Blob */}
      <div className="absolute top-10 right-0 w-80 h-80 bg-[#00B4D8]/8 rounded-full filter blur-[80px] pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 relative flex justify-center">
            {/* Visual Frame */}
            <div className="relative w-80 sm:w-96 h-[460px] rounded-[36px] overflow-hidden bg-[#0A1628] border border-white/10 shadow-xl group">
              {/* Doctor Image */}
              <img 
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 text-white bg-brand-navy/60 backdrop-blur-md border-t border-white/10 rounded-t-[28px]">
                <div className="flex items-center justify-between mb-2">
                  <div>
                    <h4 className="font-heading text-2xl font-bold tracking-tight">Dr. Iqbal</h4>
                    <p className="text-brand-cyan text-xs tracking-wider uppercase font-semibold">Chief Homeopathic Consultant</p>
                  </div>
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="space-y-3">
              <span className="text-brand-cyan font-accent text-sm font-semibold tracking-wider uppercase">Meet the Specialist</span>
              <h3 className="font-heading text-3xl sm:text-4xl font-extrabold text-white tracking-tight leading-tight">
                Dr. Iqbal, BHMS
              </h3>
              <p className="text-[#00B4D8] font-semibold text-base font-accent">
                15+ Years of Dedicated Clinical Experience in Classic Homeopathy
              </p>
            </div>

            <div className="text-slate-300 text-base leading-relaxed space-y-4 font-light">
              <p>
                Dr. Iqbal is a leading homeopathic practitioner based in Kanpur, Uttar Pradesh. Having completed his Bachelor of Homeopathic Medicine and Surgery (BHMS), he has spent over a decade and a half helping patients recover from chronic illnesses without introducing toxic loads or side effects.
              </p>
              <p>
                His treatment philosophy is rooted in <strong>constitutional homeopathy</strong>, which analyzes each patient’s physical, psychological, and hereditary traits. This ensures that therapy cures the underlying cause of disease rather than providing short-term, superficial symptom suppression.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
              ...
              {/* Credentials */}
              <div className="flex items-start space-x-3 p-4 bg-[#162847]/40 border border-white/10 rounded-2xl">
                <div className="p-2.5 bg-blue-500/10 text-brand-cyan border border-brand-cyan/20 rounded-xl shrink-0 mt-0.5">
                  <GraduationCap className="h-5 w-5" />
                </div>
                <div>
                  <h4 className="font-bold text-brand-cyan text-sm font-heading">Credentials</h4>
            ...
            {/* Timings & Map Tag */}
            <div className="flex flex-col sm:flex-row sm:items-center justify-between p-5 border border-brand-cyan/20 bg-[#162847]/40 rounded-3xl gap-4">
              ...
              <Link href="/book" className="h-12 px-6 flex items-center justify-center space-x-2 bg-brand-blue hover:bg-brand-blue/90 text-white rounded-xl font-semibold transition-all shadow-md shadow-brand-blue/20">
