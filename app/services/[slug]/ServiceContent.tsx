...
import { Calendar, CheckCircle2, ArrowLeft, ArrowRight, Stethoscope } from 'lucide-react';
...
export default function ServiceContent({ service, otherServices }: ServiceContentProps) {
  return (
